        ...
        <Navbar.Collapse id="my-nav">
          <Nav className="mr-auto" >
            ...
            <NavDropdown className="nav-dropdown"  title="Дома">
              <NavDropdown.Item href="/homes-general">Общая информация</NavDropdown.Item>
              <NavDropdown.Item href="/photogallery">Фотогалерея</NavDropdown.Item>
            ...
            <NavDropdown className="nav-dropdown"  title="Документы и отчетность">
            ...
            <NavDropdown className="nav-dropdown"  title="Вопросы и Ответы">
